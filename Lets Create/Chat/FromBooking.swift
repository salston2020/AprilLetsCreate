...
//  Lets Create
//
//  Created by Sheena Alston on 4/25/21.
//
...
final class FromBooking: UIViewController {
    ...
    private let searchBar: UISearchBar = {
        ...
        searchBar.placeholder = "\("postedBy")"
        return searchBar
    }()
...
extension FromBooking: UITableViewDelegate, UITableViewDataSource {
...
extension FromBooking: UISearchBarDelegate {
